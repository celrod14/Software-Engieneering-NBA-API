...
fetch('https://www.balldontlie.io/api/v1/stats?seasons[]=2020&per_page=100000')
  ...
  .then(data => {
	...
	// 	 let statsUrls = [`https://www.balldontlie.io/api/v1/season_averages?seasons=2018&player_ids[]=${player1.player_id}`,
	// 	 `https://www.balldontlie.io/api/v1/season_averages?seasons=2018&player_ids[]=${player2.player_id}`
	//   ];
