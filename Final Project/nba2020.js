fetch('https://www.balldontlie.io/api/v1/stats?seasons[]=2022&per_page=10000')
      ...
      rows.forEach(row => {
        ...
        // check if player is already selected
          ...
          if (selectedPlayers.length === 2) {
            ...
            //   fetch player stats
            let statsUrls = [`https://www.balldontlie.io/api/v1/stats?player_ids[]=${player1.id}&seasons[]=2022`,
               `https://www.balldontlie.io/api/v1/stats?player_ids[]=${player2.id}&seasons[]=2022`
            ];
            ...
            .then(statsData => {
              ...
              fg_pct1 = player1.fg_pct*100 ?? "N/A"
              fg_pct2 = player2.fg_pct*100 ?? "N/A"
              fg3_pct1 = player1.fg3_pct*100 ?? "N/A"
              fg3_pct2 = player2.fg3_pct*100 ?? "N/A"
              ft_pct1 = player1.ft_pct*100 ?? "N/A"
              ft_pct2 = player2.ft_pct*100 ?? "N/A"
              ...
              infoHtml += `
                <table>
                  ...
                  <tr><td>Field Goal %</td><td>${fg_pct1.toFixed(2)}%</td><td>${fg_pct2.toFixed(2)}%</td></tr>
                  <tr><td>3-Point %</td><td>${fg3_pct1.toFixed(2)}%</td><td>${fg3_pct1.toFixed(2)}%</td></tr>
                  <tr><td>Free Throw %</td><td>${ft_pct1.toFixed(2)}%</td><td>${ft_pct2.toFixed(2)}%</td></tr>
